...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddApplicationServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHttpClient<ScientificJournal.DataAccess.External.OpenAlexClient>();
        services.AddHttpClient<ScientificJournal.DataAccess.External.SemanticScholarClient>();
        services.AddHttpClient<ScientificJournal.DataAccess.External.GoogleScholarClient>();
