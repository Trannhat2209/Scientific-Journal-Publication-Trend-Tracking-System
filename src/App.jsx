...
const adminNavItems = [
  ...
  },
  {
    ...
    icon: "M4 6h16v12H4zM7 10l2 2-2 2M11 14h5",
  },
];
...
function AdminShell({
  ...
  return (
    <main className={`admin-app ${mobileOpen ? "sidebar-mobile-open" : ""}`}>
...
export default function App() {
  ...
  if (path === "/admin-user-management")
    return <AdminSectionPage activeRoute={path} title="User Management" />;
  if (path === "/admin-system-logs")
    return <AdminSectionPage activeRoute={path} title="System Logs" />;
