...
public class AuthService : IAuthService
{
    ...
    public async Task<AuthResponseDto> RegisterAsync(RegisterRequestDto request)
    {
        ...
        var user = new User
        {
            ...
            Role = UserRole.Student, // every new account starts as Student; upgrading to Researcher/Lecturer happens by purchasing a plan
            IsActive = true,
            IsDeleted = false,
    ...
    {
        var hasProAccess = user.HasProAccess();
        return new UserProfileDto
        {
            ...
            SearchAccuracy = PlanPolicy.GetSearchAccuracy(user.Role, hasProAccess)
        };
    }
}
