...
const string FrontendCorsPolicy = "ScholarTrendFrontend";
...
static bool IsAllowedFrontendOrigin(string? origin)
{
    ...
    var isViteOrLocalAppPort =
        uri.Port is >= 5173 and <= 5180 or 3000 or 3001 or 4173;
    var isLocalHost =
        host == "localhost" ||
        host == "127.0.0.1" ||
        host == "::1" ||
    ...
    return isLocalHost && isViteOrLocalAppPort;
}
